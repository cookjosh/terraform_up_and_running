...
resource "aws_autoscaling_group" "example" {
    ...
    # The above line sets the ASG's name to depend on the launch configuration's name
    # forcing a replacement if we make changes to the user-facing code in the launch config
